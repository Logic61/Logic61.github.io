...
![[Pasted image 20260402140342.png]]
...
- **抛物面：** $z = \frac{1}{3}(x^2+y^2) \implies \rho \cos\phi = \frac{1}{3}\rho^2 \sin^2\phi \implies \rho = \frac{3\cos\phi}{\sin^2\phi}$
    

通过联立方程 $2 = \frac{3\cos\phi}{\sin^2\phi}$，解得交线处的临界角 **$\phi = \frac{\pi}{3}$**。
...
- **第一部分：** $2\pi \int_{0}^{\frac{\pi}{3}} 2\sin\phi \, d\phi = 4\pi [-\cos\phi]_{0}^{\frac{\pi}{3}} = 4\pi (\frac{1}{2}) = 2\pi$
    
- **第二部分：** $2\pi \int_{\frac{\pi}{3}}^{\frac{\pi}{2}} \sin\phi \cdot \frac{3\cos\phi}{\sin^2\phi} \, d\phi = 6\pi \int_{\frac{\pi}{3}}^{\frac{\pi}{2}} \frac{\cos\phi}{\sin\phi} \, d\phi = 6\pi [\ln(\sin\phi)]_{\frac{\pi}{3}}^{\frac{\pi}{2}}$
