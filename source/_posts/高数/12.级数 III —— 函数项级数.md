...
\end{cases}$$
![[Pasted image 20260510105820.png]]
#### 3. 核心结论
...
$\{f_n\}$ 在 $X$ 上**一致收敛**（即存在函数 $f$ 使得 $f_n \rightrightarrows f$）的**充分必要条件**是：
...
若 $$S_n(x) = \sum_{k=1}^{n} u_k(x) \rightrightarrows S(x) = \sum_{n=1}^{+\infty} u_n(x)$$
